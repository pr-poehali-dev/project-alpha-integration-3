        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-4 py-2 rounded-full w-fit">
              ...
              <span className="text-sm font-medium">Английский • Немецкий • TOEFL • IELTS</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight text-balance">
              Освойте язык и сдайте международный экзамен
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Персональные уроки английского и немецкого, профессиональная подготовка к TOEFL IBT и IELTS.
              Занимайтесь в удобное время и достигайте нужного балла.
            </p>
