    ...
    <section id="booking" className="bg-muted/30 py-20 md:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 text-balance">Запишитесь на пробный урок</h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
            Выберите удобное время и начните путь к свободному владению языком или высокому баллу на экзамене
          </p>
        </div>
